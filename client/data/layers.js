...
var insight_ly = {
	...
	opioid: {
		...
		in_opioid_prescribing_rate: {
			...
			tooltip: 'Percentage of opioid prescriptions in the medicare and medicaid programs in 2016.',
			name: 'Rx Rates',
			suffix: '',
			stateMin: 2.94,
			stateMax: 7.47,
		...
		in_opioid_prescribing_rate_pct_change: {
			...
			zindex: 90,
			label: ' in Rx Rate',
			tooltip: 'Percent change in percentage of opioid prescriptions in the medicare and medicaid programs over 4 years, 2013-2016.',
			name: 'Rx Trends',
			suffix: '%',
			stateMin: -19.42,
			stateMax: -0.15,
