...
var insight_ly = {
	...
	opioid: {
		...
		in_opioid_prescribing_rate: {
			...
			tooltip: 'Opioid prescribing patterns (% opioid claims) in the Medicare and Medicaid programs for 2016.',
			name: 'Rx Rates',
			suffix: '',
			stateMin: 2.94,
			stateMax: 7.47,
		...
		in_opioid_prescribing_rate_pct_change: {
			...
			zindex: 90,
			label: ' in Rx Rate',
			tooltip: 'Percent change in opioid prescribing patterns (% opioid claims) in the Medicare and Medicaid program over 4 years, 2013-2016.',
			name: 'Rx Trends',
			suffix: '%',
			stateMin: -19.42,
			stateMax: -0.15,
